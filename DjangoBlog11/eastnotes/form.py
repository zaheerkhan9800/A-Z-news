...
class RegForm(forms.Form):
    ...
    password = forms.CharField(label='fa fa-lock',min_length=6,widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Enter a password of atleast 6 digits'}))
